    ...
    Private Sub LoadReport()
        ...
        With RSC
            If CheckBox1.Checked = False Then
                Call LoadSqlData("SELECT " & SLF & " " & _
                           ",N'" & MDOffName & "' as txtoff_name     ," & _
                               " N'" & MDOffTel & "' as txtoff_tel      , " & _
                               " N'" & MDPlace & "' as   txtoff_Place  , " & _
                                     "N'" & "ໃບລາຍງານຜົນໄດ້ຮັບ" & "' as txtReport_name  ," & _
                                       "N'" & "( " & Lb.Text & " )" & "' as txtReport_Date  FROM Ap_Rpt_Income " & RPT_ID & "   ", RSC)



                If RD.Checked = True Or RM.Checked = True Then
                ...
                If RP.Checked = True Then
                    Dim Frm As New FmPreview
                    Dim Rpt As New CryRpt_Income_Q
                    Rpt.SetDataSource(RSC)
                    Rpt.Refresh()
                    Frm.ReportViewer.ReportSource = Rpt
                    Frm.ReportViewer.DisplayGroupTree = False
                ...
                If RY.Checked = True Then
                    Dim Frm As New FmPreview
                    Dim Rpt As New CryRpt_Income_Y
                    Rpt.SetDataSource(RSC)
                    Rpt.Refresh()
                    Frm.ReportViewer.ReportSource = Rpt
                    Frm.ReportViewer.DisplayGroupTree = False
            ...
            Else
                Call LoadSqlData("SELECT " & SLF & " " & _
                          ",N'" & MDOffName & "' as txtoff_name     ," & _
                              ...
                              " N'" & MDPlace & "' as   txtoff_Place  , " & _
                                    "N'" & "ໃບລາຍງານຜົນໄດ້ຮັບ" & "' as txtReport_name  ," & _
                                      "N'" & "( " & Lb.Text & " )" & "' as txtReport_Date  FROM Ap_Rpt_Incon_Detail   ", RSC)
        ...
        '                     " N'" & MDPlace & "' as   txtoff_Place  , " & _
        '                           "N'" & "ໃບລາຍງານຜົນໄດ້ຮັບ" & "' as txtReport_name  ," & _
        '                             "N'" & "( " & Lb.Text & " )" & "' as txtReport_Date  FROM Ap_Rpt_Income   ", CNN, ADODB.CursorTypeEnum.adOpenForwardOnly, ADODB.LockTypeEnum.adLockReadOnly)
        ...
        With Rs
            ...
            .Open("SELECT " & SLF & " " & _
                         ",N'" & MDOffName & "' as txtoff_name     ," & _
                             ...
                             " N'" & MDPlace & "' as   txtoff_Place  , " & _
                                   "N'" & "ໃບລາຍງານຜົນໄດ້ຮັບ" & "' as txtReport_name  ," & _
                                     "N'" & "( " & Lb.Text & " )" & "' as txtReport_Date  FROM Ap_Rpt_Income_Item where    Current_Month <>0  or Quarter_to_Date <>0  Year_to_Date <>0  ", CNN, ADODB.CursorTypeEnum.adOpenForwardOnly, ADODB.LockTypeEnum.adLockReadOnly)
