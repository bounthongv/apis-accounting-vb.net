Public Class FmRestorData
    ...
    Private Sub FmRestorData_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FG.FormatString = "^ລ/ດ |<ວັນທີ        |< ຊື່ເອກະສານ                                  "
            ...
            If .RecordCount <> 0 Then
                While Not .EOF
                    FG.AddItem(.AbsolutePosition & _
                              Chr(9) & Format(CDate(.Fields("File_Date").Value.ToString), "dd/MM/yyyy") & _
                              Chr(9) & ((.Fields("File_Nme").Value.ToString)))
                    .MoveNext()
                End While
            Else
                FG.Rows = 4
    ...
    Private Sub FG_SelChange(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FG.SelChange
        ...
        txtSaveIn.Text = Microsoft.VisualBasic.Left(a, b) & "\BackUp Data\" & FG.get_TextMatrix(FG.Row, 2)
    End Sub
