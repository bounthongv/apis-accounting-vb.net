...
Public Class CryLoanStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryLoanStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryLoanStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryLoanStatus = New CryLoanStatus
        rpt.Site = Me.Site
        Return rpt
    End Function
