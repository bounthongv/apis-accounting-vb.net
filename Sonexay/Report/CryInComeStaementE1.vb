...
Public Class CryInComeStaementE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryInComeStaementE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryInComeStaementE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryInComeStaementE = New CryInComeStaementE
        rpt.Site = Me.Site
        Return rpt
    End Function
