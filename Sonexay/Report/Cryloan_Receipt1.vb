...
Public Class Cryloan_Receipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Cryloan_Receipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryloan_Receipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cryloan_Receipt = New Cryloan_Receipt
        rpt.Site = Me.Site
        Return rpt
    End Function
