...
Public Class CryLoanRePayTeble
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryLoanRePayTeble.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryLoanRePayTeble
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryLoanRePayTeble = New CryLoanRePayTeble
        rpt.Site = Me.Site
        Return rpt
    End Function
