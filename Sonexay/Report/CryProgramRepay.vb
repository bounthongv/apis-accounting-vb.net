...
Public Class CryProgramRepay
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryProgramRepay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryProgramRepay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryProgramRepay = New CryProgramRepay
        rpt.Site = Me.Site
        Return rpt
    End Function
