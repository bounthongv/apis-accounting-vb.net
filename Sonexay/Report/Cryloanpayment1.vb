...
Public Class Cryloanpayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Cryloanpayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryloanpayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cryloanpayment = New Cryloanpayment
        rpt.Site = Me.Site
        Return rpt
    End Function
