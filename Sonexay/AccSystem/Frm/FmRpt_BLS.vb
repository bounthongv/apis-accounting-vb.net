...
hang:
    ...
    Private Sub LoadMonth()
        ...
        'MdStartDate = Format(CDate("01/" & CDbl(DMonth.SelectedIndex + 1) & "/" & Year(DMonth.Value)), "dd-MM-yyyy")
        'MdToDate = Format(CDate("01/" & CDbl(DMonth.SelectedIndex + 1) & "/" & Year(DMonth.Value)), "dd-MM-yyyy")
        ...
        '    RmFrdate.Text = "ປະຈໍາເດືອນ: " & CFromMonth.Text & " ປີ: " & Format(MuStardate, "yyyy")
        'Else
        '    RmFrdate.Text = "ແຕ່ເດືອນ: " & CFromMonth.Text & "/" & Format(MuStardate, "yyyy") & "ຫາເດືອນ: " & CToMonth.Text & "/" & Format(MuStardate, "yyyy")
        'End If
        ...
        'End If
        ''-----------------
        'Lb.Text = "ປະຈຳເດືອນ " & DMonth.Text & "/" & Year(MdToDate)
        '---------------------------------
        If FmMain.MnLaoLang.Checked = True Then
