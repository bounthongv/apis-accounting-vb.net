...
Public Class CryRpt_Income_Itemxx
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryRpt_Income_Itemxx.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Income_Itemxx.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Income_Itemxx
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Income_Itemxx = New CryRpt_Income_Itemxx
        rpt.Site = Me.Site
        Return rpt
    End Function
