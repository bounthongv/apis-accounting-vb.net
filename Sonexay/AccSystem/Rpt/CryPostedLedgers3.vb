...
Public Class CryPostedLedgers3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryPostedLedgers3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPostedLedgers3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPostedLedgers3 = New CryPostedLedgers3
        rpt.Site = Me.Site
        Return rpt
    End Function
