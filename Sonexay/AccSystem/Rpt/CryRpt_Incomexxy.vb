...
Public Class CryRpt_Incomexxy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Incomexxy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Incomexxy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Incomexxy = New CryRpt_Incomexxy
        rpt.Site = Me.Site
        Return rpt
    End Function
