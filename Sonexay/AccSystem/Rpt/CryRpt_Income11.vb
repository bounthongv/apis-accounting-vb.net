...
Public Class CryRpt_Income1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Income1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Income1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Income1 = New CryRpt_Income1
        rpt.Site = Me.Site
        Return rpt
    End Function
