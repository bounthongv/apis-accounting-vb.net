...
Public Class Crybandon_year
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Crybandon_year.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrybandon_year
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crybandon_year = New Crybandon_year
        rpt.Site = Me.Site
        Return rpt
    End Function
