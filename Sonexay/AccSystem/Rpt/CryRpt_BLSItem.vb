...
Public Class CryRpt_BLSItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_BLSItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_BLSItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_BLSItem = New CryRpt_BLSItem
        rpt.Site = Me.Site
        Return rpt
    End Function
