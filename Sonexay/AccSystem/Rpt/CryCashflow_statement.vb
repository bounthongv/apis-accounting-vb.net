...
Public Class CryCashflow_statement
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryCashflow_statement.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryCashflow_statement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryCashflow_statement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryCashflow_statement = New CryCashflow_statement
        rpt.Site = Me.Site
        Return rpt
    End Function
