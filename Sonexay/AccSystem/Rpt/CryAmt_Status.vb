...
Public Class CryAmt_Status
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryAmt_Status.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryAmt_Status
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryAmt_Status = New CryAmt_Status
        rpt.Site = Me.Site
        Return rpt
    End Function
