...
Public Class CryRpt_BLS_M_Exp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_BLS_M_Exp.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_dd() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCryRpt_BLS_M_Exp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_BLS_M_Exp = New CryRpt_BLS_M_Exp
        rpt.Site = Me.Site
        Return rpt
    End Function
