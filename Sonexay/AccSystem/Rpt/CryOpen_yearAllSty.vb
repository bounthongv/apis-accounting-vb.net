...
Public Class CryOpen_yearAllSty
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryOpen_yearAllSty.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryOpen_yearAllSty
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryOpen_yearAllSty = New CryOpen_yearAllSty
        rpt.Site = Me.Site
        Return rpt
    End Function
