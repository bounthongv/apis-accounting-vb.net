...
Public Class CryShartOfAcc2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryShartOfAcc2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryShartOfAcc2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryShartOfAcc2 = New CryShartOfAcc2
        rpt.Site = Me.Site
        Return rpt
    End Function
