...
Public Class CryGeneralLedgers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryGeneralLedgers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryGeneralLedgers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryGeneralLedgers = New CryGeneralLedgers
        rpt.Site = Me.Site
        Return rpt
    End Function
