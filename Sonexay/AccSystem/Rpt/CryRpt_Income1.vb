...
Public Class CryRpt_Income
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Income.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Income
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Income = New CryRpt_Income
        rpt.Site = Me.Site
        Return rpt
    End Function
