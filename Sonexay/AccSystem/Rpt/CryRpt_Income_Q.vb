...
Public Class CryRpt_Income_Q
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Income_Q.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Income_Q
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Income_Q = New CryRpt_Income_Q
        rpt.Site = Me.Site
        Return rpt
    End Function
