...
Public Class CryShartOfAcc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryShartOfAcc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryShartOfAcc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryShartOfAcc = New CryShartOfAcc
        rpt.Site = Me.Site
        Return rpt
    End Function
