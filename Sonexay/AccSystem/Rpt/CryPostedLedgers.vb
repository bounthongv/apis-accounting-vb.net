...
Public Class CryPostedLedgers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryPostedLedgers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPostedLedgers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPostedLedgers = New CryPostedLedgers
        rpt.Site = Me.Site
        Return rpt
    End Function
