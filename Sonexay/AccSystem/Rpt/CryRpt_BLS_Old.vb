...
Public Class CryRpt_BLS_Old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_BLS_Old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_BLS_Old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_BLS_Old = New CryRpt_BLS_Old
        rpt.Site = Me.Site
        Return rpt
    End Function
