...
Public Class CryRpt_GrpEng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_GrpEng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_GrpEng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_GrpEng = New CryRpt_GrpEng
        rpt.Site = Me.Site
        Return rpt
    End Function
