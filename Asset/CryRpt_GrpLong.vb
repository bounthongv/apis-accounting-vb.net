...
Public Class CryRpt_GrpLong
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_GrpLong.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_GrpLong
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_GrpLong = New CryRpt_GrpLong
        rpt.Site = Me.Site
        Return rpt
    End Function
