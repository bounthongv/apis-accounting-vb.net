...
Public Class CryAss_ListLand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryAss_ListLand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryAss_ListLand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryAss_ListLand = New CryAss_ListLand
        rpt.Site = Me.Site
        Return rpt
    End Function
