...
Public Class Cry_Asset_GroupE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Cry Asset GroupE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Asset_GroupE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Asset_GroupE = New Cry_Asset_GroupE
        rpt.Site = Me.Site
        Return rpt
    End Function
