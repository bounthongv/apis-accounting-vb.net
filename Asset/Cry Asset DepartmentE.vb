...
Public Class Cry_Asset_DepartmentE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cry Asset DepartmentE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Cry Asset DepartmentE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Asset_DepartmentE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Asset_DepartmentE = New Cry_Asset_DepartmentE
        rpt.Site = Me.Site
        Return rpt
    End Function
