...
Public Class Cry_Asset_Group
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Cry Asset Group.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Asset_Group
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Asset_Group = New Cry_Asset_Group
        rpt.Site = Me.Site
        Return rpt
    End Function
