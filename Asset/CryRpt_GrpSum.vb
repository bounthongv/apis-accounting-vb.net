...
Public Class CryRpt_GrpSum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_GrpSum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_GrpSum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_GrpSum = New CryRpt_GrpSum
        rpt.Site = Me.Site
        Return rpt
    End Function
