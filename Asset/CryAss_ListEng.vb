...
Public Class CryAss_ListEng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryAss_ListEng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryAss_ListEng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryAss_ListEng = New CryAss_ListEng
        rpt.Site = Me.Site
        Return rpt
    End Function
