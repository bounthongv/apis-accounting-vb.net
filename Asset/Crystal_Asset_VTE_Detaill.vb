...
Public Class Crystal_Asset_VTE_Detaill
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crystal_Asset_VTE_Detaill.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Crystal_Asset_VTE_Detaill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystal_Asset_VTE_Detaill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_Asset_VTE_Detaill = New Crystal_Asset_VTE_Detaill
        rpt.Site = Me.Site
        Return rpt
    End Function
