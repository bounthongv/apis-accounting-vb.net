...
Public Class CryRpt_GrpLongEng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_GrpLongEng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_GrpLongEng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_GrpLongEng = New CryRpt_GrpLongEng
        rpt.Site = Me.Site
        Return rpt
    End Function
