...
Public Class CryRpt_GrpLongNoBr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_GrpLongNoBr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_GrpLongNoBr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_GrpLongNoBr = New CryRpt_GrpLongNoBr
        rpt.Site = Me.Site
        Return rpt
    End Function
