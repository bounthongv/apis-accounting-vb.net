...
Public Class Cry_Asset_Department
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cry Asset Department.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Cry Asset Department.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Asset_Department
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Asset_Department = New Cry_Asset_Department
        rpt.Site = Me.Site
        Return rpt
    End Function
