...
Public Class CryAss_BrokeEng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryAss_BrokeEng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryAss_BrokeEng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryAss_BrokeEng = New CryAss_BrokeEng
        rpt.Site = Me.Site
        Return rpt
    End Function
