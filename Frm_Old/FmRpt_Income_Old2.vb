Public Class FmRpt_Income_Old2
        ...
        Else
            If CMB_Curr.SelectedIndex = 0 Then
                If CheckBox7.Checked = True Then
                    CNN.Execute("INSERT INTO Ap_balance_6 ( ac_code  , open_amt_dr, open_amt_cr , amt_dr , amt_cr   ) " & _
                          " select ac_code, 0 , 0 , sum(amt_dr)/" & CDbl(txtRate2.Text) & " , sum(amt_cr)/" & CDbl(txtRate2.Text) & "  from gen_jn  WHERE date_work   BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "' AND '" & Format(MdToDate, "yyyy-MM-dd") & "' " & Ac_Code & " " & MULook2 & "  group BY ac_code ")
                    Dim S As Date = MdStartDate : S = DateAdd("d", CDbl(-1), MdStartDate)
                    CNN.Execute("INSERT INTO Ap_balance_6 ( ac_code  , open_amt_dr, open_amt_cr , amt_dr , amt_cr   ) " & _
                    " select ac_code , sum(amt_dr)/" & CDbl(txtRate2.Text) & " , sum(amt_cr)/" & CDbl(txtRate2.Text) & " , 0 , 0 from gen_jn  WHERE date_work   BETWEEN '" & "1-1-" & Format(MdStartDate, "yyyy") & "' AND '" & Format(S, "yyyy-MM-dd") & "' " & Ac_Code & " " & MULook2 & "   group BY ac_code")
                    CNN.Execute("INSERT INTO Ap_balance_6 ( ac_code  , open_amt_dr, open_amt_cr , amt_dr , amt_cr   ) " & _
                    " select ac_code  , sum(amt_dr)/" & CDbl(txtRate2.Text) & " , sum(amt_cr)/" & CDbl(txtRate2.Text) & "  , 0 , 0 from Open_jn WHERE    date_work='" & "1-1-" & Format(MdStartDate, "yyyy") & "' " & Ac_Code & " " & MULook2 & "   group BY ac_code")

                ElseIf CheckBox6.Checked = True Then
                    CNN.Execute("INSERT INTO Ap_balance_6 ( ac_code  , open_amt_dr, open_amt_cr , amt_dr , amt_cr   ) " & _
                      " select ac_code, 0 , 0 , sum(amt_dr)/" & CDbl(txtRate.Text) & " , sum(amt_cr)/" & CDbl(txtRate.Text) & "  from gen_jn  WHERE date_work   BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "' AND '" & Format(MdToDate, "yyyy-MM-dd") & "' " & Ac_Code & " " & MULook2 & "  group BY ac_code ")
                    Dim S As Date = MdStartDate : S = DateAdd("d", CDbl(-1), MdStartDate)
                    CNN.Execute("INSERT INTO Ap_balance_6 ( ac_code  , open_amt_dr, open_amt_cr , amt_dr , amt_cr   ) " & _
                ...
                Else
                    CNN.Execute("INSERT INTO Ap_balance_6 ( ac_code  , open_amt_dr, open_amt_cr , amt_dr , amt_cr   ) " & _
                    " select ac_code  ,  0 As open_amt_dr, 0 As open_amt_cr , sum(amount_Dr)as amt_dr , sum(amount_Cr)as amt_cr  from gen_jn  WHERE  1=1  and Curr=N'LAK' and date_work   BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "' AND '" & Format(MdToDate, "yyyy-MM-dd") & "' " & Ac_Code & " " & MULook2 & "  group BY ac_code ")

                    CNN.Execute("INSERT INTO Ap_balance_6 ( ac_code  , open_amt_dr, open_amt_cr , amt_dr , amt_cr   ) " & _
                    " select ac_code  ,  0 As open_amt_dr, 0 As open_amt_cr , sum(amount_Dr)* " & CDbl(txtRate.Text) & " as amt_dr , sum(amount_cr)* " & CDbl(txtRate.Text) & " as amt_cr  from gen_jn  WHERE  1=1  and Curr=N'USD' and date_work   BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "' AND '" & Format(MdToDate, "yyyy-MM-dd") & "' " & Ac_Code & " " & MULook2 & "  group BY ac_code ")
...
hang:
    ...
    Private Sub LoadReport()
        ...
        LngId = "7094" : CallLngStr() : MuLngRpt = MuLngRpt & "N'" & LngStr & " " & DTDATE02 & "' As Crl_RptName ,"
        ...
        SLF = "SELECT   " & Doc & "  as Doc  ,   N'" & MuOffDep & "'  as RptSjoff_Dep  ,  " & mformat & "  as mformat  ,   " & MuLngRpt & "  * , N'" & INNM & "' As Crl_InMounth ,N'" & LastNM & "' As Crl_LastMounth , N'" & INNM & "' as In_Mn, N'" & LastNM & "' as Last_Mn    FROM Ap_Rpt_Income_Old  "
    ...
    Private Sub AAA()
        ...
        If RSC.RecordCount = 0 Then
            CNN.Execute("insert into Ap_Rpt_Income_Old_M_M( Rpt_ID_Nme, Description, Descriptione, Amt, Chart_of_Accounts_Codes, Oject, RPT_Type, Fnt, Clor, x, Udln, Last_Amt, Lck, clt_Str, clt_Amt, NL) " & _
         " select  Rpt_ID_Nme, Description, Descriptione, Amt, Chart_of_Accounts_Codes, Oject, RPT_Type, Fnt, Clor, x, Udln, Last_Amt, Lck, clt_Str, clt_Amt, NL from Ap_Rpt_Income_Old ")
        End If
    ...
    Private Sub BtnPreview_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPreview.Click
        ...
        '  CNN.Execute(" update Ap_Rpt_Income_Item_Old set Amt_Dr=0, Amt_Cr=0, Last_Amt_Dr=0, Last_Amt_Cr=0 ")
        '  CNN.Execute(" update Ap_Rpt_Income_Item_Old set Ap_Rpt_Income_Item_Old.Amt_Dr=Ap_balance_6_col.Rem_Dr from Ap_Rpt_Income_Item_Old, Ap_balance_6_col where Ap_Rpt_Income_Item_Old.Ac_Code=Ap_balance_6_col.Ac_Code  ")
        '  CNN.Execute(" update Ap_Rpt_Income_Item_Old set Ap_Rpt_Income_Item_Old.Amt_Cr=Ap_balance_6_col.Rem_Cr from Ap_Rpt_Income_Item_Old, Ap_balance_6_col where Ap_Rpt_Income_Item_Old.Ac_Code=Ap_balance_6_col.Ac_Code  ")

        '  CNN.Execute(" update Ap_Rpt_Income_Item_Old set Ap_Rpt_Income_Item_Old.Last_Amt_Dr=Ap_balance_6_col.open_Amt_Dr from Ap_Rpt_Income_Item_Old, Ap_balance_6_col where Ap_Rpt_Income_Item_Old.Ac_Code=Ap_balance_6_col.Ac_Code  ")
        '  CNN.Execute(" update Ap_Rpt_Income_Item_Old set Ap_Rpt_Income_Item_Old.Last_Amt_Cr=Ap_balance_6_col.open_Amt_Cr from Ap_Rpt_Income_Item_Old, Ap_balance_6_col where Ap_Rpt_Income_Item_Old.Ac_Code=Ap_balance_6_col.Ac_Code  ")

        '  CNN.Execute(" delete Ap_Rpt_Income_Item   ")
        '  Dim SSA As String
        '  SSA = "  insert into Ap_Rpt_Income_Item ( Rpt_ID, Rpt_Type, Amt_Dr, Amt_Cr, Last_Amt_Dr, Last_Amt_Cr, Ac_Code )  " & _
        '  " select Rpt_ID, Rpt_Type, sum(Amt_Dr), 0, 0, 0, '1' from Ap_Rpt_Income_Item_Old where Amt_Dr<>0  and Rpt_Type='in' group by Rpt_ID, Rpt_Type union all " & _
        '" select Rpt_ID, Rpt_Type, 0, sum(Amt_Cr), 0, 0, '1' from Ap_Rpt_Income_Item_Old where Amt_Cr<>0  and Rpt_Type='Out' group by Rpt_ID, Rpt_Type union all " & _
        '" select Rpt_ID, Rpt_Type, 0, 0, sum(Last_Amt_Dr), 0, '1' from Ap_Rpt_Income_Item_Old where Last_Amt_Dr<>0  and Rpt_Type='in' group by Rpt_ID, Rpt_Type union all " & _
        '" select Rpt_ID, Rpt_Type, 0, 0, 0, sum(Last_Amt_Cr), '1' from Ap_Rpt_Income_Item_Old where Last_Amt_Cr<>0  and Rpt_Type='Out' group by Rpt_ID, Rpt_Type order by Rpt_ID "
        '  CNN.Execute(SSA)
        '  SSA = "  insert into Ap_Rpt_Income_Item ( Rpt_ID, Rpt_Type, Amt_Dr, Amt_Cr, Last_Amt_Dr, Last_Amt_Cr, Ac_Code )  " & _
        ' " select Rpt_ID, Rpt_Type, sum(Amt_Dr), sum(Amt_Cr), sum(Last_Amt_Dr), sum(Last_Amt_Cr), '2' from Ap_Rpt_Income_Item_Old group by Rpt_ID, Rpt_Type order by Rpt_ID "
        '  CNN.Execute(SSA)
        '  CNN.Execute(" delete Ap_Rpt_Income_Item where Ac_Code='1'  ")
        '  CNN.Execute(" update Ap_Rpt_Income_Old set Ap_Rpt_Income_Old.Amt=Ap_Rpt_Income_Item.Amt_Dr from Ap_Rpt_Income_Old, Ap_Rpt_Income_Item where Ap_Rpt_Income_Old.Rpt_ID=Ap_Rpt_Income_Item.Rpt_ID and Ap_Rpt_Income_Item.Rpt_Type='in' ")
        '  CNN.Execute(" update Ap_Rpt_Income_Old set Ap_Rpt_Income_Old.Amt=Ap_Rpt_Income_Item.Amt_Cr from Ap_Rpt_Income_Old, Ap_Rpt_Income_Item where Ap_Rpt_Income_Old.Rpt_ID=Ap_Rpt_Income_Item.Rpt_ID and Ap_Rpt_Income_Item.Rpt_Type='Out' ")
        '  CNN.Execute(" update Ap_Rpt_Income_Old set Ap_Rpt_Income_Old.Last_Amt=Ap_Rpt_Income_Item.Last_Amt_Dr from Ap_Rpt_Income_Old, Ap_Rpt_Income_Item where Ap_Rpt_Income_Old.Rpt_ID=Ap_Rpt_Income_Item.Rpt_ID and Ap_Rpt_Income_Item.Rpt_Type='in' ")
        '  CNN.Execute(" update Ap_Rpt_Income_Old set Ap_Rpt_Income_Old.Last_Amt=Ap_Rpt_Income_Item.Last_Amt_Cr from Ap_Rpt_Income_Old, Ap_Rpt_Income_Item where Ap_Rpt_Income_Old.Rpt_ID=Ap_Rpt_Income_Item.Rpt_ID and Ap_Rpt_Income_Item.Rpt_Type='Out' ")
        '===================SUM==================================
        '===================01.01==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.01%' ) where Rpt_ID='01.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.01%' ) where Rpt_ID='01.01' ")
        '===================01.02==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.02%' ) where Rpt_ID='01.02' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.02%' ) where Rpt_ID='01.02' ")
        '===================01.03.01==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where ( Rpt_ID='01.01' or Rpt_ID='01.02' or Rpt_ID='01.03' ) ) where Rpt_ID='01.03.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where ( Rpt_ID='01.01' or Rpt_ID='01.02' or Rpt_ID='01.03' ) ) where Rpt_ID='01.03.01' ")
        '===================01.14.01==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where ( Rpt_ID='01.03.01' or Rpt_ID='01.04' or Rpt_ID='01.05' or Rpt_ID='01.06' or Rpt_ID='01.07' or Rpt_ID='01.08' or Rpt_ID='01.09' or Rpt_ID='01.11' or Rpt_ID='01.12' or Rpt_ID='01.13' or Rpt_ID='01.14' ) ) where Rpt_ID='01.14.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set amt= amt - (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.10' ) where Rpt_ID='01.14.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where ( Rpt_ID='01.03.01' or Rpt_ID='01.04' or Rpt_ID='01.05' or Rpt_ID='01.06' or Rpt_ID='01.07' or Rpt_ID='01.08' or Rpt_ID='01.09' or Rpt_ID='01.11' or Rpt_ID='01.12' or Rpt_ID='01.13' or Rpt_ID='01.14' ) ) where Rpt_ID='01.14.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt= Last_Amt - (select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.10' ) where Rpt_ID='01.14.01' ")
        '===================01.16==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.16%' ) where Rpt_ID='01.16' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.16%' ) where Rpt_ID='01.16' ")
        '===================01.19==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.19%' ) where Rpt_ID='01.19' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID like '01.19%' ) where Rpt_ID='01.19' ")
        '===================01.20.01==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where ( Rpt_ID='01.16' or Rpt_ID='01.17' or Rpt_ID='01.18' or Rpt_ID='01.19' or Rpt_ID='01.20' ) ) where Rpt_ID='01.20.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set amt= amt - (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.15' ) where Rpt_ID='01.20.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where ( Rpt_ID='01.16' or Rpt_ID='01.17' or Rpt_ID='01.18' or Rpt_ID='01.19' or Rpt_ID='01.20' ) ) where Rpt_ID='01.20.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt= Last_Amt - (select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.15' ) where Rpt_ID='01.20.01' ")
        '===================01.20.02==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.14.01' ) - (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.20.01' ) where Rpt_ID='01.20.02' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.14.01' ) - (select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.20.01' ) where Rpt_ID='01.20.02' ")
        '===================01.23.01==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.20.02' ) + (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.21' ) - (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.22' ) - (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.23' ) where Rpt_ID='01.23.01' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.20.02' ) + (select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.21' ) - (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.22' ) - (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.23' ) where Rpt_ID='01.23.01' ")
        '===================02==================================
        CNN.Execute(" update Ap_Rpt_Income_Old set amt=(select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.23.01' ) + (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.24' ) + (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.25' ) + (select sum(Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.26' ) where Rpt_ID='02' ")
        CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=(select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.23.01' ) + (select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.24' ) + (select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.25' ) + (select sum(Last_Amt) from Ap_Rpt_Income_Old where Rpt_ID='01.26' ) where Rpt_ID='02' ")

        If DMonth.SelectedIndex = 0 Then
            CNN.Execute(" update Ap_Rpt_Income_Old set Last_Amt=0 ")
        End If
    ...
    Private Sub CMB_Curr_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMB_Curr.SelectedIndexChanged
        ...
        Else
            Button2.Text = "EQVL ACC"
            CheckBox7.Text = "EQVL Money"
            If CMB_Curr.Text = "LAK" Then
                CheckBox7.Text = "EQVL USD"
            ElseIf CMB_Curr.Text = "USD" Then
                CheckBox7.Text = "EQVL LAK"
            Else
                CheckBox7.Text = "EQVL USD"
            End If
        End If
