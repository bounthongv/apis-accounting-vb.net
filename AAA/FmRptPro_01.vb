Public Class FmRptPro_01
    Dim MuBTW, MuLFTD, MuLFTD222 As String
    Dim CLT_Str, CLT_Last_Str As String
    Dim hh As String = 0
    Dim MUTY02, MUTY03, MUTY04 As String

    Dim cn As New Odbc.OdbcConnection
    Private Sub HeaDer()
        LoadSqlData("SELECT * FROM Header WHERE ID=N'B05' ", RSC)
        ...
        If MuLng = "L" Then
            ...
            If RSC.RecordCount = 0 Then
                CNN.Execute("INSERT INTO Header(ID,Nm,S1,S2,S3,S4,PP) " & _
                            " values('B05',N'" & TxtHeader.Text & "',N'" & TxtS1.Text & "',N'" & TxtS2.Text & "',N'" & TxtS3.Text & "',N'" & TxtS4.Text & "',N'" & TxtPP.Text & "') ")
            Else
    ...
    Private Sub CacuO22()
        ...
        'MuBTW = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY02 & "' " & MULook2 & " "
        ...
        '    MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY02 & "' " & MULook2 & " "
        'Else
        '    'MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY & "' " & MULook2 & " "

        '    MuLFTD = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY02 & "' " & MULook2 & " "
        'End If

        Off_Find = Off_Usr.Text : MuTable = "" : Call Find_Company()
        MuBTW = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY02 & "' " & MULook2 & " "
        'MuLFTD = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "/01/01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY & "' " & MULook2 & " "
        MuBTW = " ='" & "01-01-" & Format(MdStartDate, "yyyy") & "'  And RptType = '" & MUTY02 & "' " & MULook2 & " "
        If Format(MdStartDate, "yyyy-MM-dd") = Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01" Then
            MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY02 & "' " & MULook2 & " "
        Else
            MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY02 & "' " & MULook2 & " "
            ...
            MuLFTD222 = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY02 & "' " & MULook2 & " "
        End If
       ...
       "  where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Dr-Cr' and RptType = '" & MUTY02 & "' "
        ...
        " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Cr-Dr' and RptType ='" & MUTY02 & "' "
        ...
        SqlClient = vbCrLf & SqlClient & "  Update So_Rpt_Proitems set OpenAmt= b.OpenDr, Amt =   b.amtDr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
         " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Dr' and RptType = '" & MUTY02 & "' "
        ...
        " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Cr' and RptType = '" & MUTY02 & "' "


        SqlClient = vbCrLf & SqlClient & "   insert into So_Rpt_ProUpdate (RptID, OpenAmt, Amt)  select RptID,isnull(sum(OpenAmt),0),isnull(sum(Amt),0) from  So_Rpt_Proitems where    RptType = '" & MUTY02 & "' group by RptID "
        SqlClient = vbCrLf & SqlClient & "  Update So_Rpt_Pro set   OpenAmt= b.OpenAmt ,  Amt= b.Amt   from So_Rpt_Pro AS a,So_Rpt_ProUpdate As b   where  a.RptType = '" & MUTY02 & "'   And a.RptID=b.RptID "
        ...
        SqlClient = vbCrLf & SqlClient & " Update So_Rpt_Pro set Amt= Amt +OpenAmt where    RptType = '" & MUTY02 & "' "
        CnnEdit()
    End Sub
    Private Sub CacuO33()
        'Off_Find = Off_Usr.Text : MuTable = "" : Call Find_Company()
        'MuBTW = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY03 & "' " & MULook2 & " "
        ''MuLFTD = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "/01/01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY & "' " & MULook2 & " "

        'If Format(MdStartDate, "yyyy-MM-dd") = Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01" Then
        '    MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY03 & "' " & MULook2 & " "
        'Else
        '    'MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY & "' " & MULook2 & " "

        '    MuLFTD = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY03 & "' " & MULook2 & " "
        'End If
        'SqlClient = ""
        'SqlClient = vbCrLf & SqlClient & "    delete So_Rpt_ProUpdate  Update So_Rpt_Pro set   OpenAmt = 0 , Amt=0  where  RptType = '" & MUTY03 & "'   Update So_Rpt_Pro set   OpenAmt = 0 , Amt=0   where  RptType = '" & MUTY03 & "'  Update So_Rpt_Proitems set OpenAmt=0 , Amt = 0  Delete So_Rpt_ProDetail  "
        ...
        MuBTW = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY03 & "' " & MULook2 & " "
        'MuLFTD = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "/01/01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY & "' " & MULook2 & " "
        MuBTW = " ='" & "01-01-" & Format(MdStartDate, "yyyy") & "'  And RptType = '" & MUTY03 & "' " & MULook2 & " "
        If Format(MdStartDate, "yyyy-MM-dd") = Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01" Then
            MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY03 & "' " & MULook2 & " "
        Else
            MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY03 & "' " & MULook2 & " "
            ...
            MuLFTD222 = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY03 & "' " & MULook2 & " "
        End If
        ...
        SqlClient = vbCrLf & SqlClient & " Update  So_Rpt_ProDetail set AmtDr = 0 , AmtCr=0   from So_Rpt_ProDetail as a , So_Rpt_Proitems as b where a.RptID=b.RptID and a.acCode=b.AcCode and b.SelAmt=0"
        SqlClient = vbCrLf & SqlClient & " Update So_Rpt_Proitems set OpenAmt= b.OpenDr-b.OpenCr, Amt =   b.amtDr-b.amtCr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
       "  where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Dr-Cr' and RptType = '" & MUTY03 & "' "

        SqlClient = vbCrLf & SqlClient & "    Update So_Rpt_Proitems set OpenAmt= b.OpenCr-b.OpenDr, Amt =   b.amtCr-b.amtDr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
        " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Cr-Dr' and RptType ='" & MUTY03 & "' "

        SqlClient = vbCrLf & SqlClient & "  Update So_Rpt_Proitems set OpenAmt= b.OpenDr, Amt =   b.amtDr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
         " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Dr' and RptType = '" & MUTY03 & "' "

        SqlClient = vbCrLf & SqlClient & "     Update So_Rpt_Proitems set OpenAmt= b.OpenCr, Amt =   b.amtCr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
        " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Cr' and RptType = '" & MUTY03 & "' "


        SqlClient = vbCrLf & SqlClient & "   insert into So_Rpt_ProUpdate (RptID, OpenAmt, Amt)  select RptID,isnull(sum(OpenAmt),0),isnull(sum(Amt),0) from  So_Rpt_Proitems where    RptType = '" & MUTY03 & "' group by RptID "
        SqlClient = vbCrLf & SqlClient & "  Update So_Rpt_Pro set   OpenAmt= b.OpenAmt ,  Amt= b.Amt   from So_Rpt_Pro AS a,So_Rpt_ProUpdate As b   where  a.RptType = '" & MUTY03 & "'   And a.RptID=b.RptID "
        'SqlClient = vbCrLf & SqlClient & " Update So_Rpt_Pro set   " & _
        '" OpenAmt= (Select isnull(SUM(OpenAmt),0) from So_Rpt_Proitems where RptID=b.RptID ) ,   " & _
        '" Amt= (Select isnull(SUM(Amt),0) from So_Rpt_Proitems where RptID=b.RptID)   " & _
        '" from  So_Rpt_Pro as a , So_Rpt_Proitems as b where a.RptID=b.RptID "
        SqlClient = vbCrLf & SqlClient & " Update So_Rpt_Pro set Amt= Amt +OpenAmt where    RptType = '" & MUTY03 & "' "
        CnnEdit()
    End Sub
    Private Sub CacuO44()
        'Off_Find = Off_Usr.Text : MuTable = "" : Call Find_Company()
        ...
        'SqlClient = vbCrLf & SqlClient & " insert into So_Rpt_ProDetail (RptID , AcCode,OpenDr,OpenCr,AmtDr,AmtCr, LCk) Select RptID,AcCode, isnull(Sum(OpenDr),0), isnull(Sum(OpenCr),0) , isnull(Sum(AmtDr),0) , isnull(Sum(AmtCr),0),1  from So_Rpt_ProDetail Group by RptID,AcCode"
        Off_Find = Off_Usr.Text : MuTable = "" : Call Find_Company()
        MuBTW = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY04 & "' " & MULook2 & " "
        'MuLFTD = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "/01/01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY & "' " & MULook2 & " "
        MuBTW = " ='" & "01-01-" & Format(MdStartDate, "yyyy") & "'  And RptType = '" & MUTY04 & "' " & MULook2 & " "
        If Format(MdStartDate, "yyyy-MM-dd") = Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01" Then
            MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY04 & "' " & MULook2 & " "
        Else
            MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY04 & "' " & MULook2 & " "
            'MuLFTD = "BETWEEN '" & Format(MdStartDate, "yyyy-MM-dd") & "'  AND  '" & Format(MdToDate, "yyyy-MM-dd") & "' And RptType = '" & MUTY & "' " & MULook2 & " "

            MuLFTD222 = "BETWEEN '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy") & "-01-01'  AND  '" & Format(CDate(DateAdd(DateInterval.Day, -1, MdStartDate)), "yyyy-MM-dd") & "'  And RptType = '" & MUTY04 & "' " & MULook2 & " "
        End If
        SqlClient = ""
        SqlClient = vbCrLf & SqlClient & "    delete So_Rpt_ProUpdate  Update So_Rpt_Pro set   OpenAmt = 0 , Amt=0   where  RptType = '" & MUTY04 & "'  Update So_Rpt_Pro set   OpenAmt = 0 , Amt=0    where  RptType = '" & MUTY04 & "'  Update So_Rpt_Proitems set OpenAmt=0 , Amt = 0  Delete So_Rpt_ProDetail  "
        SqlClient = vbCrLf & SqlClient & " Insert into So_Rpt_ProDetail (RptID , AcCode, AmtDr, AmtCr) Select  b.RptID , ac_code , isnull(sum(amt_Dr),0) ,isnull(sum(amt_Cr),0)  from gen_jn as a , So_Rpt_Proitems as b   where  a.ac_code=b.AcCode And b.CurrType = 0 And a.Date_Work " & MuLFTD & " group by  a.ac_code ,  b.RptID   "
        SqlClient = vbCrLf & SqlClient & " Insert into So_Rpt_ProDetail (RptID , AcCode, OpenDr, OpenCr) Select  b.RptID , ac_code , isnull(sum(amt_Dr),0) ,isnull(sum(amt_Cr),0)  from gen_jn as a , So_Rpt_Proitems as b   where a.ac_code=b.AcCode And b.CurrType = 0 And a.Date_Work " & MuLFTD222 & " group by  a.ac_code ,  b.RptID  "
        SqlClient = vbCrLf & SqlClient & " Insert into So_Rpt_ProDetail (RptID , AcCode, OpenDr, OpenCr) Select  b.RptID , ac_code , isnull(sum(amt_Dr),0) ,isnull(sum(amt_Cr),0)  from Open_jn as a , So_Rpt_Proitems as b   where a.ac_code=b.AcCode And b.CurrType = 0 And a.Date_Work " & MuBTW & " group by  a.ac_code ,  b.RptID  "
        ...
        SqlClient = vbCrLf & SqlClient & " Update  So_Rpt_ProDetail set AmtDr = 0 , AmtCr=0   from So_Rpt_ProDetail as a , So_Rpt_Proitems as b where a.RptID=b.RptID and a.acCode=b.AcCode and b.SelAmt=0"
        SqlClient = vbCrLf & SqlClient & " Update So_Rpt_Proitems set OpenAmt= b.OpenDr-b.OpenCr, Amt =   b.amtDr-b.amtCr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
       "  where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Dr-Cr' and RptType = '" & MUTY04 & "' "

        SqlClient = vbCrLf & SqlClient & "    Update So_Rpt_Proitems set OpenAmt= b.OpenCr-b.OpenDr, Amt =   b.amtCr-b.amtDr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
        " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Cr-Dr' and RptType ='" & MUTY04 & "' "

        SqlClient = vbCrLf & SqlClient & "  Update So_Rpt_Proitems set OpenAmt= b.OpenDr, Amt =   b.amtDr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
         " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Dr' and RptType = '" & MUTY04 & "' "

        SqlClient = vbCrLf & SqlClient & "     Update So_Rpt_Proitems set OpenAmt= b.OpenCr, Amt =   b.amtCr  from  So_Rpt_Proitems as a ,So_Rpt_ProDetail as b   " & _
        " where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Cr' and RptType = '" & MUTY04 & "' "


        SqlClient = vbCrLf & SqlClient & "   insert into So_Rpt_ProUpdate (RptID, OpenAmt, Amt)  select RptID,isnull(sum(OpenAmt),0),isnull(sum(Amt),0) from  So_Rpt_Proitems where    RptType = '" & MUTY04 & "' group by RptID "
        SqlClient = vbCrLf & SqlClient & "  Update So_Rpt_Pro set   OpenAmt= b.OpenAmt ,  Amt= b.Amt   from So_Rpt_Pro AS a,So_Rpt_ProUpdate As b   where  a.RptType = '" & MUTY04 & "'   And a.RptID=b.RptID "
        'SqlClient = vbCrLf & SqlClient & " Update So_Rpt_Pro set   " & _
        '" OpenAmt= (Select isnull(SUM(OpenAmt),0) from So_Rpt_Proitems where RptID=b.RptID ) ,   " & _
        '" Amt= (Select isnull(SUM(Amt),0) from So_Rpt_Proitems where RptID=b.RptID)   " & _
        '" from  So_Rpt_Pro as a , So_Rpt_Proitems as b where a.RptID=b.RptID "
        ...
        CnnEdit()
    End Sub
    Private Sub Update_Sumo22()
        SqlClient = ""
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Rpt set  CLT_Amt  = CLT_Str ,  CLT_Last_Amt  = CLT_Str  where ( CLT_Str = '+' or CLT_Str = '-' or CLT_Str = '*' or CLT_Str = '+' or CLT_Str = '/' or CLT_Str = '(' or CLT_Str=')' Or CLT_Str<>'Cast(('   Or CLT_Str<>')As Float) '  )    And ( Rpt_Type = '" & MUTY02 & "'  ) "
        SqlClient = vbCrLf & SqlClient & " delete Caculate_Lock"
        SqlClient = vbCrLf & SqlClient & " delete Caculate_Start  "
        SqlClient = vbCrLf & SqlClient & "  Insert Into Caculate_Start (Rpt_Id , Rpt_Type , clt_Str , clt_Amt , Clt_Last_Amt ) select Rpt_Id , Rpt_Type , clt_Str , clt_Amt , Clt_Last_Amt from Caculate_Rpt where Rpt_Type = '" & MUTY02 & "'  Order by  Rpt_id ,cnt asc "
        ...
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Start set Caculate_Start.Amt = So_Rpt_Pro.Amt , Caculate_Start.Last_Amt = So_Rpt_Pro.OpenAmt   from Caculate_Start , So_Rpt_Pro  where  Caculate_Start.CLT_Str  = So_Rpt_Pro.RptId and RptType = '" & MUTY02 & "'    "
        ...
        CLT_Last_Str = ""
        With RSC1
            Call LoadSqlData("select *  from Caculate_Start where  Rpt_Type = '" & MUTY02 & "'  Order by  Rpt_id ,cnt asc", RSC1)
...
hang:
                        If Err.Number = 0 Then
                            'If (RSC1.Fields("Rpt_ID").Value.ToString) = "03" Then
                            Dim ss11 As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and    RptType = '" & MUTY02 & "'  "
                            CNN.Execute(ss11)
                            'End If
                        Else
                            Dim s As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and    RptType = '" & MUTY02 & "'"
                            's = 0
        ...
        End With
    End Sub
    Private Sub Update_Sumo33()
        SqlClient = ""
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Rpt set  CLT_Amt  = CLT_Str ,  CLT_Last_Amt  = CLT_Str  where ( CLT_Str = '+' or CLT_Str = '-' or CLT_Str = '*' or CLT_Str = '+' or CLT_Str = '/' or CLT_Str = '(' or CLT_Str=')' Or CLT_Str<>'Cast(('   Or CLT_Str<>')As Float) '  )    And ( Rpt_Type = '" & MUTY03 & "'  ) "
        SqlClient = vbCrLf & SqlClient & " delete Caculate_Lock"
        SqlClient = vbCrLf & SqlClient & " delete Caculate_Start  "
        SqlClient = vbCrLf & SqlClient & "  Insert Into Caculate_Start (Rpt_Id , Rpt_Type , clt_Str , clt_Amt , Clt_Last_Amt ) select Rpt_Id , Rpt_Type , clt_Str , clt_Amt , Clt_Last_Amt from Caculate_Rpt where Rpt_Type = '" & MUTY03 & "'  Order by  Rpt_id ,cnt asc "
        SqlClient = vbCrLf & SqlClient & " update Caculate_Start set lck =0  "
        SqlClient = vbCrLf & SqlClient & " Insert into Caculate_Lock (cnt_Mt)  SELECT  (SELECT     TOP 1 cnt FROM Caculate_Start AS B WHERE(Rpt_Id = A.Rpt_Id   ) ORDER BY cnt desc) AS cnt FROM Caculate_Start  AS A  GROUP BY Rpt_Id ORDER BY Rpt_Id "
        SqlClient = vbCrLf & SqlClient & " update  Caculate_Start set lck=1 from Caculate_Start ,Caculate_Lock  where Caculate_Start.cnt=Caculate_Lock.cnt_MT  "
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Start set Caculate_Start.Amt = So_Rpt_Pro.Amt , Caculate_Start.Last_Amt = So_Rpt_Pro.OpenAmt   from Caculate_Start , So_Rpt_Pro  where  Caculate_Start.CLT_Str  = So_Rpt_Pro.RptId and RptType = '" & MUTY03 & "'    "
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Start set lck_Amt=0 "
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Start set lck_Amt=1 where CLT_Str <> '+' And CLT_Str <> '-' And CLT_Str <> '*' And CLT_Str <> '+' And CLT_Str <> '/' And CLT_Str <> '(' And CLT_Str<>')' And CLT_Str<>'Cast(('   And CLT_Str<>')As Float)' "
        CnnEdit()
        ...
        CLT_Last_Str = ""
        With RSC1
            Call LoadSqlData("select *  from Caculate_Start where  Rpt_Type = '" & MUTY03 & "'  Order by  Rpt_id ,cnt asc", RSC1)
            If .RecordCount > 0 Then
                While Not .EOF()
                    'If (RSC1.Fields("Rpt_ID").Value.ToString) = "03" Then
                    If (RSC1.Fields("lck_Amt").Value.ToString) = "1" Then
...
hang:
                        If Err.Number = 0 Then
                            'If (RSC1.Fields("Rpt_ID").Value.ToString) = "03" Then
                            Dim ss11 As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and    RptType = '" & MUTY03 & "'  "
                            CNN.Execute(ss11)
                            'End If
                        Else
                            Dim s As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and    RptType = '" & MUTY03 & "'"
                            's = 0
                            MessageBox.Show("ສູດຄິດໄລ່ຂອງ " & (RSC1.Fields("Rpt_ID").Value.ToString) & " = " & CLT_Str & " ບໍ່ຖຶກຕ້ອງກະລຸນນາກວດສອບຄືນໃຫມ່")
                            Exit Sub
                        End If
        ...
        End With
    End Sub
    Private Sub Update_Sumo44()
        SqlClient = ""
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Rpt set  CLT_Amt  = CLT_Str ,  CLT_Last_Amt  = CLT_Str  where ( CLT_Str = '+' or CLT_Str = '-' or CLT_Str = '*' or CLT_Str = '+' or CLT_Str = '/' or CLT_Str = '(' or CLT_Str=')' Or CLT_Str<>'Cast(('   Or CLT_Str<>')As Float) '  )    And ( Rpt_Type = '" & MUTY04 & "'  ) "
        SqlClient = vbCrLf & SqlClient & " delete Caculate_Lock"
        SqlClient = vbCrLf & SqlClient & " delete Caculate_Start  "
        SqlClient = vbCrLf & SqlClient & "  Insert Into Caculate_Start (Rpt_Id , Rpt_Type , clt_Str , clt_Amt , Clt_Last_Amt ) select Rpt_Id , Rpt_Type , clt_Str , clt_Amt , Clt_Last_Amt from Caculate_Rpt where Rpt_Type = '" & MUTY04 & "'  Order by  Rpt_id ,cnt asc "
        SqlClient = vbCrLf & SqlClient & " update Caculate_Start set lck =0  "
        SqlClient = vbCrLf & SqlClient & " Insert into Caculate_Lock (cnt_Mt)  SELECT  (SELECT     TOP 1 cnt FROM Caculate_Start AS B WHERE(Rpt_Id = A.Rpt_Id   ) ORDER BY cnt desc) AS cnt FROM Caculate_Start  AS A  GROUP BY Rpt_Id ORDER BY Rpt_Id "
        SqlClient = vbCrLf & SqlClient & " update  Caculate_Start set lck=1 from Caculate_Start ,Caculate_Lock  where Caculate_Start.cnt=Caculate_Lock.cnt_MT  "
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Start set Caculate_Start.Amt = So_Rpt_Pro.Amt , Caculate_Start.Last_Amt = So_Rpt_Pro.OpenAmt   from Caculate_Start , So_Rpt_Pro  where  Caculate_Start.CLT_Str  = So_Rpt_Pro.RptId and RptType = '" & MUTY04 & "'    "
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Start set lck_Amt=0 "
        SqlClient = vbCrLf & SqlClient & " Update Caculate_Start set lck_Amt=1 where CLT_Str <> '+' And CLT_Str <> '-' And CLT_Str <> '*' And CLT_Str <> '+' And CLT_Str <> '/' And CLT_Str <> '(' And CLT_Str<>')' And CLT_Str<>'Cast(('   And CLT_Str<>')As Float)' "
        CnnEdit()
        ...
        CLT_Last_Str = ""
        With RSC1
            Call LoadSqlData("select *  from Caculate_Start where  Rpt_Type = '" & MUTY04 & "'  Order by  Rpt_id ,cnt asc", RSC1)
            If .RecordCount > 0 Then
                While Not .EOF()
                    'If (RSC1.Fields("Rpt_ID").Value.ToString) = "03" Then
                    If (RSC1.Fields("lck_Amt").Value.ToString) = "1" Then
...
hang:
                        If Err.Number = 0 Then
                            'If (RSC1.Fields("Rpt_ID").Value.ToString) = "03" Then
                            Dim ss11 As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and    RptType = '" & MUTY04 & "'  "
                            CNN.Execute(ss11)
                            'End If
                        Else
                            Dim s As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and    RptType = '" & MUTY04 & "'"
                            's = 0
                            MessageBox.Show("ສູດຄິດໄລ່ຂອງ " & (RSC1.Fields("Rpt_ID").Value.ToString) & " = " & CLT_Str & " ບໍ່ຖຶກຕ້ອງກະລຸນນາກວດສອບຄືນໃຫມ່")
                            Exit Sub
                        End If
    ...
    Private Sub BtnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPreview.Click
        ...
        If MUTY = "PRO1" Then
            'CNN.Execute(" update  So_Rpt_Pro set Amt= ((select amt  from  So_Rpt_Pro where RptType = 'PRO1' and RptID = '07' )/(select amt  from So_Rpt_Pro where RptType = 'PRO1' and RptID = '15' ))*100  where RptType = 'PRO1' and RptID = '16' ")
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO2' and RptID = '38' ) where RptType = 'PRO1' and RptID = '01' ")
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO2' and RptID = '17' ) where RptType = 'PRO1' and RptID = '03' ")
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO2' and RptID = '22' ) where RptType = 'PRO1' and RptID = '04' ")
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO2' and RptID = '37' ) where RptType = 'PRO1' and RptID = '05' ")

            'CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO2' and RptID = '22' ) where RptType = 'PRO1' and RptID = '09' ")
            'CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO2' and RptID = '37' ) where RptType = 'PRO1' and RptID = '10' ")
            Call PRO33()
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO3' and RptID = '18' ) where RptType = 'PRO1' and RptID = '06' ")
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO3' and RptID = '18' ) where RptType = 'PRO1' and RptID = '08' ")
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO3' and RptID = '08' ) where RptType = 'PRO1' and RptID = '09' ")
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amt  from So_Rpt_Pro where RptType = 'PRO3' and RptID = '17' ) where RptType = 'PRO1' and RptID = '10' ")
            '=========pro04 28============
            Call PRO44()
            CNN.Execute(" update   So_Rpt_Pro set Amt= (select amtb  from So_Rpt_Pro where RptType = 'PRO4' and RptID = '28' ) where RptType = 'PRO1' and RptID = '02' ")
            Update_Sum()
    ...
    Private Sub Cacu()
       ...
       "  where a.RptID=b.RptID and a.AcCode=b.AcCode and a.RptStatus='Dr-Cr' and RptType = '" & MUTY & "' "
        ...
        '" Amt= (Select isnull(SUM(Amt),0) from So_Rpt_Proitems where RptID=b.RptID)   " & _
        '" from  So_Rpt_Pro as a , So_Rpt_Proitems as b where a.RptID=b.RptID "
        SqlClient = vbCrLf & SqlClient & " Update So_Rpt_Pro set Amt= Amt +OpenAmt where    RptType = '" & MUTY & "' "
        CnnEdit()
    End Sub
...
hang:
                        If Err.Number = 0 Then
                            'If (RSC1.Fields("Rpt_ID").Value.ToString) = "03" Then
                            Dim ss11 As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and RptType = '" & MUTY & "'  "
                            CNN.Execute(ss11)
                            'End If
                        Else
                            Dim s As String = " Update  So_Rpt_Pro set Amt = " & CLT_Str & " , OpenAmt = " & CLT_Last_Str & " where  RptID =   '" & (RSC1.Fields("Rpt_ID").Value.ToString) & "'  and RptType = '" & MUTY & "'  "
                            's = 0
                            MessageBox.Show("ສູດຄິດໄລ່ຂອງ " & (RSC1.Fields("Rpt_ID").Value.ToString) & " = " & CLT_Str & " ບໍ່ຖຶກຕ້ອງກະລຸນນາກວດສອບຄືນໃຫມ່")
                            Exit Sub
                        End If
