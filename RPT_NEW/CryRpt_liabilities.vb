...
Public Class CryRpt_liabilities
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_liabilities.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_liabilities
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_liabilities = New CryRpt_liabilities
        rpt.Site = Me.Site
        Return rpt
    End Function
