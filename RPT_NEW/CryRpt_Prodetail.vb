...
Public Class CryRpt_Prodetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Prodetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Prodetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Prodetail = New CryRpt_Prodetail
        rpt.Site = Me.Site
        Return rpt
    End Function
