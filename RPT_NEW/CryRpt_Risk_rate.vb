...
Public Class CryRpt_Risk_rate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Risk_rate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Risk_rate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Risk_rate = New CryRpt_Risk_rate
        rpt.Site = Me.Site
        Return rpt
    End Function
