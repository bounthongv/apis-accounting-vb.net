...
Public Class CryRpt_BLSM_M
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_BLSM_M.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_BLSM_M
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_BLSM_M = New CryRpt_BLSM_M
        rpt.Site = Me.Site
        Return rpt
    End Function
