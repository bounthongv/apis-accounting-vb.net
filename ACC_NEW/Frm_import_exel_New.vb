...
Public Class Frm_import_exel_New
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        For i = 0 To DataGridView1.RowCount - 2
            If DataGridView1.Item(1, i).Value.ToString <> "" Then
             ...
             Chr(9) & DataGridView1.Item(3, i).Value.ToString & Chr(9) & DataGridView1.Item(4, i).Value.ToString & Chr(9) & DataGridView1.Item(5, i).Value.ToString & _
              Chr(9) & DataGridView1.Item(6, i).Value.ToString & _
                Chr(9) & DataGridView1.Item(7, i).Value.ToString & _
                  Chr(9) & DataGridView1.Item(8, i).Value.ToString & _
                 Chr(9) & DataGridView1.Item(9, i).Value.ToString & _
                  Chr(9) & Val(DataGridView1.Item(10, i).Value.ToString) & _
                  Chr(9) & Val(DataGridView1.Item(11, i).Value.ToString) & _
                    Chr(9) & (DataGridView1.Item(12, i).Value.ToString) & _
                      Chr(9) & Val(DataGridView1.Item(13, i).Value.ToString) & _
                        Chr(9) & Val(DataGridView1.Item(14, i).Value.ToString) & _
                          Chr(9) & Val(DataGridView1.Item(15, i).Value.ToString) & _
    ...
    Private Sub Insert_Gen_jn()
        ...
        With Rschk
            For i = 1 To FG.Rows - 1
                Dim sk As String = "Select * FROM gen_jn where  certify=N'" & FG.get_TextMatrix(i, 3) & "'  "
                Call LoadSqlData(sk, Rschk)
                If Rschk.RecordCount = 0 Then
