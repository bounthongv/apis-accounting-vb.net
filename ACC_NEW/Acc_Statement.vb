...
Public Class Acc_Statement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.Acc_Statement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAcc_Statement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Acc_Statement = New Acc_Statement
        rpt.Site = Me.Site
        Return rpt
    End Function
