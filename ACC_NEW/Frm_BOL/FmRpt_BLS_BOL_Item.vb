Public Class FmRpt_BLS_BOL_Item
    ...
    Private Sub BtnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEdit.Click
        ...
        BtnMove.Visible = False
        BtnSearch.Visible = False
        'CNN.Execute("delete Ap_Rpt_BLS_BOL")
        Dim aa As String = ""
        Dim i As Integer
        For i = 1 To FG.Rows - 1
            ...
            CNN.Execute("Update Ap_Rpt_BLS_BOL Set  Description = N'" & Apostrophe(FG.get_TextMatrix(i, 2)) & "' ,  Descriptione = N'" & Apostrophe(FG.get_TextMatrix(i, 3)) & "' , Chart_of_Accounts_Codes = N'" & FG.get_TextMatrix(i, 4) & "'  Where Rpt_ID = '" & FG.get_TextMatrix(i, 1) & "'")


            'CNN.Execute("INSERT INTO Ap_Rpt_BLS_BOL( Rpt_ID,  Description , Descriptione  ,Chart_of_Accounts_Codes , Grp , Grp_Nme ) " & _
