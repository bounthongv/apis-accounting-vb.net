...
Public Class CryRpt_BLS_BOL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_BLS_BOL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_BLS_BOL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_BLS_BOL = New CryRpt_BLS_BOL
        rpt.Site = Me.Site
        Return rpt
    End Function
