Public Class FmRpt_Income_Item_BOL
    ...
    Public Sub LoadListFG()
        ...
        With RSC
            ...
            Call LoadSqlData("SELECT * FROM  Ap_Rpt_Income_BOL    ", RSC)
    ...
    Private Sub loadBankItem()
        ...
        With RSC
            'Call LoadData("select *  from Open_jn WHERE ac_code<>''  " & Sql & "order by ac_code", RSC)
            FG2.FormatString = "^ລ/ດ |< ລະຫັດ   |<ລະຫັດບັນຊີ    |<ຊື່ບັນຊີ(ພາສາລາວ)                               |<ຊື່ບັນຊີ(ພາສາອັງກິດ)                  |<ສະຖານນະພາບ"
            Call LoadSqlData("SELECT * FROM  Ap_Rpt_Income_BOL_Item where Rpt_ID=   '" & TextBox1.Text & "' Order by Ac_Code ", RSC)
            If .RecordCount > 0 Then
                While Not .EOF
                    ...
                    "" & vbTab & Trim(CStr(.Fields("Rpt_Type").Value.ToString)))
                    .MoveNext()
                End While
            Else
            End If
    ...
    Private Sub BtnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSearch.Click
        ...
        FG.Focus()
        CNN.Execute("delete Ap_Rpt_Income_BOL_Item where Rpt_ID = '" & TextBox1.Text & "' ")
        Dim i As Integer
        For i = 1 To FG2.Rows - 1
            ...
            End If
            Dim aa As String
            aa = "INSERT INTO Ap_Rpt_Income_BOL_Item( Rpt_ID,  Ac_Code , Ac_Name , Ac_NameE   , BLS , Rpt_Type ) " & _
    ...
    Private Sub BtnMove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMove.Click
        CNN.Execute("delete Ap_Rpt_Income_BOL_Item where Ac_Code like '" & AC_Code.Text & "%' And Rpt_ID = '" & RPT_ID.Text & "' And Rpt_Type = '" & Rpt_Type.Text & "' ")
        BtnMove.Visible = False
        Call loadBankItem()
    End Sub
    ...
    Private Sub BtnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEdit.Click
        ...
        'CNN.Execute("delete Ap_Rpt_Income_BOL")
        Dim i As Integer
        For i = 1 To FG.Rows - 1
            If FG.get_TextMatrix(i, 1) = "" And FG.get_TextMatrix(i, 2) = "" Then
                Exit Sub
            End If
            CNN.Execute("Update Ap_Rpt_Income_BOL Set  Description = N'" & Apostrophe(FG.get_TextMatrix(i, 2)) & "' ,  Descriptione = N'" & Apostrophe(FG.get_TextMatrix(i, 3)) & "' , Chart_of_Accounts_Codes = N'" & FG.get_TextMatrix(i, 4) & "'  Where Rpt_ID = '" & FG.get_TextMatrix(i, 1) & "'")
            'CNN.Execute("INSERT INTO Ap_Rpt_Income_BOL( Rpt_ID,  Description , Descriptione    , Chart_of_Accounts_Codes , Grp , Grp_Nme ) " & _
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        '        Exit Sub
        '    End If
        '    CNN.Execute("INSERT INTO Ap_Rpt_Income_BOL_Item( Rpt_ID,  Ac_Code , Ac_Name , Ac_NameE   , BLS , Rpt_Type ) " & _
        '         "Values('" & FG2.get_TextMatrix(i, 1) & "', N'" & FG2.get_TextMatrix(i, 2) & "', N'" & FG2.get_TextMatrix(i, 3) & "','" & FG2.get_TextMatrix(i, 4) & "','" & "ALL" & "' , '" & FG2.get_TextMatrix(i, 5) & "')")
        'Next i
    End Sub
    ...
    Private Sub AC_Code_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles AC_Code.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            LoadSqlData("Select top 1 Rpt_ID , Ac_Code from Ap_Rpt_Income_BOL_Item where  Ac_Code like '" & AC_Code.Text & "%'  And Rpt_ID <> '" & RPT_ID.Text & "'  ", RSC)
            ...
            CNN.Execute("delete Ap_Rpt_Income_BOL_Item where Ac_Code like '" & AC_Code.Text & "%' And Rpt_ID = '" & RPT_ID.Text & "' And Rpt_Type = '" & Rpt_Type.Text & "'  insert into Ap_Rpt_Income_BOL_Item (Rpt_ID , Ac_Code , Ac_Name, Rpt_Type) select '" & RPT_ID.Text & "' ,  Ac_Code , Name_L , '" & Rpt_Type.Text & "' from Acc_Code where Ac_Code like '" & AC_Code.Text & "%'  ")
            TextBox1.Text = FG.get_TextMatrix(FG.Row, 1)
            Call loadBankItem()
        End If

        'If e.KeyChar = Chr(13) Then
        '    CNN.Execute("delete Ap_Rpt_Income_BOL_Item where Ac_Code like '" & AC_Code.Text & "%' And Rpt_ID = '" & RPT_ID.Text & "' An Rpt_Type = '" & Rpt_Type.Text & "'  insert into Ap_Rpt_Income_BOL_Item (Rpt_ID , Ac_Code , Ac_Name, Rpt_Type) select '" & RPT_ID.Text & "' ,  Ac_Code , Name_L from Acc_Code where Ac_Code like '" & AC_Code.Text & "%' , '" & Rpt_Type.Text & "' ", )
        '    TextBox1.Text = FG.get_TextMatrix(FG.Row, 1)
        '    Call loadBankItem()
        'End If
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        CNN.Execute("delete Ap_Rpt_Income_BOL_Item where  Rpt_ID = '" & RPT_ID.Text & "'   ")
        TextBox1.Text = FG.get_TextMatrix(FG.Row, 1)
        Call loadBankItem()
    End Sub
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        With RSC
            Call LoadSqlData("SELECT * FROM  Ap_Rpt_Income_BOL_Item  Order by Ac_Code  ", RSC)
            If .RecordCount > 0 Then
                While Not .EOF
            ...
            End If
        End With
        CNN.Execute("delete Ap_Rpt_Income_BOL_Item")
        CNN.Execute(" insert into Ap_Rpt_Income_BOL_Item  (Rpt_ID , Ac_Code , Ac_Name, Rpt_Type) select Rpt_ID , Ac_Code , Ac_Name, Rpt_Type from Ap_Rpt_Item")
        MsgBox("Ok")
    End Sub
End Class