Public Class FmRpt_Income_Item_BOL
            ...
            If .RecordCount > 0 Then
                While Not .EOF
                    FG.Rows.Add(.AbsolutePosition, _
                                ...
                                Trim(CStr(.Fields("Descriptione").Value.ToString)), _
                                Trim(CStr(.Fields("Chart_of_Accounts_Codes").Value.ToString)), _
                                Trim(CStr(.Fields("Grp").Value.ToString)), _
    ...
    Private Sub BtnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEdit.Click
        ...
        For i = 0 To FG.Rows.Count - 1
            ...
            CNN.Execute("Update Ap_Rpt_Income_BOL Set  Description = N'" & Apostrophe(v2) & "' ,  Descriptione = N'" & Apostrophe(v3) & "' , Chart_of_Accounts_Codes = N'" & v4 & "'  Where Rpt_ID = '" & v1 & "'")
        Next i
    End Sub

    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ' Logic was commented out in original code
    End Sub
