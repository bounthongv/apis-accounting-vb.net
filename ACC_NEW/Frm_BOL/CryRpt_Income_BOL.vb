...
Public Class CryRpt_Income_BOL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApPBank10.CryRpt_Income_BOL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRpt_Income_BOL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRpt_Income_BOL = New CryRpt_Income_BOL
        rpt.Site = Me.Site
        Return rpt
    End Function
